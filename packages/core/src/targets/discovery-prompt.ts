 ...
 * with a web or MCP context. This DOES NOT inject source content; the agent is
 ...
 *
 * Discovery scoring relies on the question's fact and misstatement contract
 * plus a tool-use provenance veto: the cell must invoke at least one of its
 * configured tools. The prompt does not demand a `## Sources` block.
 */
