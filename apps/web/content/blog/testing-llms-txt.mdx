...
Point pickled at your `llms.txt` and write one scenario for a question it is supposed to answer. Run it once with the file injected and once with the agent forced to reach it through web tools, and see which promise holds.
