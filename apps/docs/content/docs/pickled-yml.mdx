...
- `referenceSolution.patch` is an optional positive control: a patch that, applied to the baseline, must pass the verifier. Absent, the report marks the verifier unproven.
