...
- **Toolset** is what tools the agent has: `none` (controlled, source content injected), `web` (WebSearch + WebFetch), `mcp` (any MCP server you declare).
